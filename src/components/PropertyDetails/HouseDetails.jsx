  ...
  return (
    <>
      <Stack direction={{base: 'column', md: 'row'}} justify='space-between' align={{md: 'center'}}  my='28px'>
        ...
        <Text fontWeight="extrabold" fontSize="20px" color="pink.500">Rp. {searchedHouse.price}</Text>
      </Stack>

      <Stack direction={{base:'column', lg: 'row'}} gap='6' align='flex-start'>
        <VStack align='center'>
          <Image src={searchedHouse.imageLg} alt='house' style={{ width: '100%', height: '500px' }} />
